...
{
    public static DbDialect DefaultDialect { get; internal set; }

    public static SqlString Select()
    {
        return Select("*");
    }

    public static SqlString Select(object cols, string prefix = null)
    {
        return new SqlString().Select(cols, prefix);
    }
